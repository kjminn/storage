...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgV=(ImageView) findViewById(R.id.firebase_logo);
    ...
    private void onUploadResultIntent(Intent intent) {
        ...
        Log.v("민경주", mDownloadUrl.toString());
        updateUI(mAuth.getCurrentUser());
    }
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
            ...
            StorageReference sReference=null;
            if(mDownloadUrl==null)
                sReference = storage.getReferenceFromUrl("gs://api-project-710878555557.appspot.com/photos/image:49995");
            else
                sReference = storage.getReferenceFromUrl(mDownloadUrl.toString());
            /*StorageReference gsReference = storage.getReferenceFromUrl("gs://api-project-710878555557.appspot.com/photos/image:49995");
            StorageReference httpsReference = storage.getReferenceFromUrl(mDownloadUrl.toString());*/
